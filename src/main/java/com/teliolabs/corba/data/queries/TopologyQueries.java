...
public final class TopologyQueries {
    ...
    public static final String UPSERT_SQL =
            "MERGE INTO \"%s\" target " +
                    ...
                    "           ? AS inconsistent, ? AS technology_layer, ? AS topology_type, ? AS circle, " +
                    ...
                    "        target.topology_type = source.topology_type, " +
                    ...
                    "        source.technology_layer,  source.topology_type,source.circle, source.last_modified_date) " +
                    "    WHERE NOT EXISTS ( " +
                    "        SELECT 1 " +
                    "        FROM \"%s\"" +
