...
DROP TABLE ECI_ROUTE_GJ;
CREATE TABLE ECI_ROUTE_GJ
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
    snc_name           VARCHAR2(400),
...
CREATE INDEX idx_ECI_ROUTE_GJ_snc_id ON ECI_ROUTE_GJ (snc_id);
CREATE INDEX idx_ECI_ROUTE_GJ_snc_name ON ECI_ROUTE_GJ (snc_name);
