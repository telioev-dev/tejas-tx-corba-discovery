...
(
    ...
    me_name            VARCHAR2(255) CONSTRAINT mum2_unique_me_name UNIQUE,      -- Managed Element name
...
CREATE INDEX "idx_TEJAS_ME_MUM2_native_ems_name" ON "TEJASNETWORKS_ME_MUM 2"(native_ems_name);

ALTER TABLE "TEJASNETWORKS_ME_MUM 2" add (
    delta_timestamp timestamp with time zone
);
...
CREATE TABLE "TEJASNETWORKS_ME_MUM 2_TEMP" AS SELECT * FROM "TEJASNETWORKS_ME_MUM 2" WHERE 1=0;