...
DROP TABLE "TEJASNETWORKS_ME_MUM 2";
CREATE TABLE "TEJASNETWORKS_ME_MUM 2"
(
...
CREATE INDEX idx_"TEJASNETWORKS_ME_MUM 2_native_ems_name" ON "TEJASNETWORKS_ME_MUM 2"(native_ems_name);

-- EQ --

DROP TABLE "TEJASNETWORKS_EQUIPMENT_MUM 2";
CREATE TABLE "TEJASNETWORKS_EQUIPMENT_MUM 2"
(
...
DROP TABLE "TEJASNETWORKS_PTP_MUM 2";
CREATE TABLE "TEJASNETWORKS_PTP_MUM 2"
(
    pk                 NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    ptp_id             VARCHAR2(255),
...
CREATE INDEX "idx_TEJASNETWORKS_PTP_MUM 2_me_name" ON "TEJASNETWORKS_PTP_MUM 2"(me_name);
CREATE INDEX "idx_TEJASNETWORKS_PTP_MUM 2_me_label" ON "TEJASNETWORKS_PTP_MUM 2"(me_label);
CREATE INDEX "idx_TEJASNETWORKS_PTP_MUM 2_port_native_name" ON "TEJASNETWORKS_PTP_MUM 2"(port_native_name);
CREATE INDEX "idx_TEJASNETWORKS_PTP_MUM 2_port_location" ON "TEJASNETWORKS_PTP_MUM 2"(port_location);


-- TOPOLOGY --

DROP TABLE "TEJASNETWORKS_TOPOLODY_MUM 2";
CREATE TABLE "TEJASNETWORKS_TOPOLODY_MUM 2"
(
...
CREATE INDEX "idx_TEJASNETWORKS_TOPOLODY_MUM 2_native_ems_name" ON "TEJASNETWORKS_TOPOLODY_MUM 2" (native_ems_name);

-- SNC --

DROP TABLE "TEJASNETWORKS_SNC_MUM 2";
CREATE TABLE "TEJASNETWORKS_SNC_MUM 2"
(
    pk                 NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
...
CREATE INDEX "idx_TEJASNETWORKS_SNC_MUM 2_snc_id" ON "TEJASNETWORKS_SNC_MUM 2" (snc_id);
CREATE INDEX "idx_TEJASNETWORKS_SNC_MUM 2_snc_name" ON "TEJASNETWORKS_SNC_MUM 2" (snc_name);
CREATE INDEX "idx_TEJASNETWORKS_SNC_MUM 2_circuit_id" ON "TEJASNETWORKS_SNC_MUM 2" (circuit_id);
CREATE INDEX "idx_TEJASNETWORKS_SNC_MUM 2_srf_id" ON "TEJASNETWORKS_SNC_MUM 2" (srf_id);

-- ROUTE --

DROP TABLE "TEJASNETWORKS_ROUTE_MUM 2";
CREATE TABLE "TEJASNETWORKS_ROUTE_MUM 2"
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
    snc_name           VARCHAR2(1000),
...
CREATE INDEX "idx_TEJASNETWORKS_ROUTE_MUM 2_snc_id" ON "TEJASNETWORKS_ROUTE_MUM 2" (snc_id);
CREATE INDEX "idx_TEJASNETWORKS_ROUTE_MUM 2_snc_name" ON "TEJASNETWORKS_ROUTE_MUM 2" (snc_name);
