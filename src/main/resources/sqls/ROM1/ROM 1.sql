...
DROP TABLE "TEJASNETWORKS_ME_ROM 1";
CREATE TABLE "TEJASNETWORKS_ME_ROM 1"
(
    ...
    me_name            VARCHAR2(255) CONSTRAINT rom1_unique_me_name UNIQUE,      -- Managed Element name
...
CREATE INDEX idx_"TEJASNETWORKS_ME_ROM 1_native_ems_name" ON "TEJASNETWORKS_ME_ROM 1"(native_ems_name);

-- EQ --

DROP TABLE "TEJASNETWORKS_EQUIPMENT_ROM 1";
CREATE TABLE "TEJASNETWORKS_EQUIPMENT_ROM 1"
(
...
DROP TABLE "TEJASNETWORKS_PTP_ROM 1";
CREATE TABLE "TEJASNETWORKS_PTP_ROM 1"
(
    pk                 NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    ptp_id             VARCHAR2(255),
...
CREATE INDEX "idx_TEJASNETWORKS_PTP_ROM 1_me_name" ON "TEJASNETWORKS_PTP_ROM 1"(me_name);
CREATE INDEX "idx_TEJASNETWORKS_PTP_ROM 1_me_label" ON "TEJASNETWORKS_PTP_ROM 1"(me_label);
CREATE INDEX "idx_TEJASNETWORKS_PTP_ROM 1_port_native_name" ON "TEJASNETWORKS_PTP_ROM 1"(port_native_name);
CREATE INDEX "idx_TEJASNETWORKS_PTP_ROM 1_port_location" ON "TEJASNETWORKS_PTP_ROM 1"(port_location);


-- TOPOLOGY --

DROP TABLE "TEJASNETWORKS_TOPOLODY_ROM 1";
CREATE TABLE "TEJASNETWORKS_TOPOLODY_ROM 1"
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    tp_link_name       VARCHAR2(400) CONSTRAINT rom1_unique_tp_link_name UNIQUE,
...
CREATE INDEX "idx_TEJASNETWORKS_TOPOLODY_ROM 1_native_ems_name" ON "TEJASNETWORKS_TOPOLODY_ROM 1" (native_ems_name);

-- SNC --

DROP TABLE "TEJASNETWORKS_SNC_ROM 1";
CREATE TABLE "TEJASNETWORKS_SNC_ROM 1"
(
    pk                 NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
...
CREATE INDEX "idx_TEJASNETWORKS_SNC_ROM 1_snc_id" ON "TEJASNETWORKS_SNC_ROM 1" (snc_id);
CREATE INDEX "idx_TEJASNETWORKS_SNC_ROM 1_snc_name" ON "TEJASNETWORKS_SNC_ROM 1" (snc_name);
CREATE INDEX "idx_TEJASNETWORKS_SNC_ROM 1_circuit_id" ON "TEJASNETWORKS_SNC_ROM 1" (circuit_id);
CREATE INDEX "idx_TEJASNETWORKS_SNC_ROM 1_srf_id" ON "TEJASNETWORKS_SNC_ROM 1" (srf_id);

-- ROUTE --

DROP TABLE "TEJASNETWORKS_ROUTE_ROM 1";
CREATE TABLE "TEJASNETWORKS_ROUTE_ROM 1"
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
    snc_name           VARCHAR2(1000),
...
CREATE INDEX "idx_TEJASNETWORKS_ROUTE_ROM 1_snc_id" ON "TEJASNETWORKS_ROUTE_ROM 1" (snc_id);
CREATE INDEX "idx_TEJASNETWORKS_ROUTE_ROM 1_snc_name" ON "TEJASNETWORKS_ROUTE_ROM 1" (snc_name);
