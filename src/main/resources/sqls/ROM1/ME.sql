...
CREATE INDEX "idx_TEJAS_ME_ROM1_native_ems_name" ON "TEJASNETWORKS_ME_ROM 1"(native_ems_name);

ALTER TABLE "TEJASNETWORKS_ME_ROM 1" add (
    delta_timestamp timestamp with time zone
);
...
CREATE TABLE "TEJASNETWORKS_ME_ROM 1_TEMP" AS SELECT * FROM "TEJASNETWORKS_ME_ROM 1" WHERE 1=0;