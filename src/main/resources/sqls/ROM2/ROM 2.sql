...
CREATE INDEX idx_"TEJASNETWORKS_ME_ROM 2_native_ems_name" ON "TEJASNETWORKS_ME_ROM 2"(native_ems_name);

-- EQ --

DROP TABLE "TEJASNETWORKS_EQUIPMENT_ROM 2";
CREATE TABLE "TEJASNETWORKS_EQUIPMENT_ROM 2"
(
...
DROP TABLE "TEJASNETWORKS_PTP_ROM 2";
CREATE TABLE "TEJASNETWORKS_PTP_ROM 2"
(
    pk                 NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    ptp_id             VARCHAR2(255),
...
CREATE INDEX "idx_TEJASNETWORKS_PTP_ROM 2_me_name" ON "TEJASNETWORKS_PTP_ROM 2"(me_name);
CREATE INDEX "idx_TEJASNETWORKS_PTP_ROM 2_me_label" ON "TEJASNETWORKS_PTP_ROM 2"(me_label);
CREATE INDEX "idx_TEJASNETWORKS_PTP_ROM 2_port_native_name" ON "TEJASNETWORKS_PTP_ROM 2"(port_native_name);
CREATE INDEX "idx_TEJASNETWORKS_PTP_ROM 2_port_location" ON "TEJASNETWORKS_PTP_ROM 2"(port_location);


-- TOPOLOGY --

DROP TABLE "TEJASNETWORKS_TOPOLODY_ROM 2";
CREATE TABLE "TEJASNETWORKS_TOPOLODY_ROM 2"
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    tp_link_name       VARCHAR2(400) CONSTRAINT rom2_unique_tp_link_name UNIQUE,
...
CREATE INDEX "idx_TEJASNETWORKS_TOPOLODY_ROM 2_native_ems_name" ON "TEJASNETWORKS_TOPOLODY_ROM 2" (native_ems_name);
