...
AS topology_type,
                		...
                		FROM
                			...
                			UNION
                				...
                				WHERE
                					r1.snc_id = r2.snc_id
                					AND r1.tuple_a = (SELECT MIN(tuple_a) FROM eci_route_ka   WHERE PATH_TYPE = 'PROTECTION' AND SNC_ID = r1.snc_id)
                					AND r2.tuple_a = (SELECT MIN(tuple_a) FROM eci_route_ka  WHERE PATH_TYPE = 'PROTECTION' AND SNC_ID = r2.snc_id)
