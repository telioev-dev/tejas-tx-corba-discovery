...
DROP TABLE ECI_EQUIPMENT_TN;
CREATE TABLE ECI_EQUIPMENT_TN
(
...
DROP TABLE ECI_PTP_TN;
CREATE TABLE ECI_PTP_TN
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    ptp_id             VARCHAR2(255),
...
CREATE INDEX idx_ECI_PTP_TN_me_name ON ECI_PTP_TN(me_name);
CREATE INDEX idx_ECI_PTP_TN_me_label ON ECI_PTP_TN(me_label);
CREATE INDEX idx_ECI_PTP_TN_port_native_name ON ECI_PTP_TN(port_native_name);
CREATE INDEX idx_ECI_PTP_TN_port_location ON ECI_PTP_TN(port_location);
...
DROP TABLE ECI_SNC_TN;
CREATE TABLE ECI_SNC_TN
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
...
CREATE INDEX idx_ECI_SNC_TN_snc_id ON ECI_SNC_TN (snc_id);
CREATE INDEX idx_ECI_SNC_TN_snc_name ON ECI_SNC_TN (snc_name);
CREATE INDEX idx_ECI_SNC_TN_circuit_id ON ECI_SNC_TN (circuit_id);
CREATE INDEX idx_ECI_SNC_TN_srf_id ON ECI_SNC_TN (srf_id);

-- ROUTE --

DROP TABLE ECI_ROUTE_TN;
CREATE TABLE ECI_ROUTE_TN
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
    snc_name           VARCHAR2(1000),
...
CREATE INDEX idx_ECI_ROUTE_TN_snc_id ON ECI_ROUTE_TN (snc_id);
CREATE INDEX idx_ECI_ROUTE_TN_snc_name ON ECI_ROUTE_TN (snc_name);
