...
(
    ...
    me_name            VARCHAR2(255) CONSTRAINT rom_unique_me_name UNIQUE,      -- Managed Element name
...
DROP TABLE ECI_TOPOLOGY_ROM;
CREATE TABLE ECI_TOPOLOGY_ROM
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    tp_link_name       VARCHAR2(400) CONSTRAINT rom_unique_tp_link_name UNIQUE,
...
CREATE INDEX idx_ECI_TOPOLOGY_ROM_native_ems_name ON ECI_TOPOLOGY_ROM (native_ems_name);
...
DROP TABLE ECI_ROUTE_ROM;
CREATE TABLE ECI_ROUTE_ROM
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
...
CREATE INDEX idx_ECI_ROUTE_ROM_snc_id ON ECI_ROUTE_ROM (snc_id);
CREATE INDEX idx_ECI_ROUTE_ROM_snc_name ON ECI_ROUTE_ROM (snc_name);
