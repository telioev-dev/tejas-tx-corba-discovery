...
DROP TABLE ECI_EQUIPMENT_APOLLO;
CREATE TABLE ECI_EQUIPMENT_APOLLO
(
...
DROP TABLE ECI_TOPOLOGY_APOLLO;
CREATE TABLE ECI_TOPOLOGY_APOLLO
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    tp_link_name       VARCHAR2(400) CONSTRAINT apollo_unique_tp_link_name UNIQUE,
...
CREATE INDEX idx_ECI_TOPOLOGY_APOLLO_native_ems_name ON ECI_TOPOLOGY_APOLLO (native_ems_name);

-- SNC --

DROP TABLE ECI_SNC_APOLLO;
CREATE TABLE ECI_SNC_APOLLO
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
...
CREATE INDEX idx_ECI_SNC_APOLLO_snc_id ON ECI_SNC_APOLLO (snc_id);
CREATE INDEX idx_ECI_SNC_APOLLO_snc_name ON ECI_SNC_APOLLO (snc_name);
CREATE INDEX idx_ECI_SNC_APOLLO_circuit_id ON ECI_SNC_APOLLO (circuit_id);
CREATE INDEX idx_ECI_SNC_APOLLO_srf_id ON ECI_SNC_APOLLO (srf_id);
