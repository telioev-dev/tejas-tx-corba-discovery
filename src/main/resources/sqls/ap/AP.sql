...
-- ROUTE --
DROP TABLE ECI_ROUTE_AP;
CREATE TABLE ECI_ROUTE_AP
(
    pk                 NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Primary key with sequence auto-generation
    snc_id             VARCHAR2(255),
...
CREATE INDEX idx_ECI_ROUTE_AP_snc_id ON ECI_ROUTE_AP (snc_id);
CREATE INDEX idx_ECI_ROUTE_AP_snc_name ON ECI_ROUTE_AP (snc_name);
