...
FROM (SELECT *
      FROM (SELECT r1.snc_id,
                   ...
                   r1.path_type
            FROM
                		              "tejasnetworks_route_mum 1" r1,
                		          "tejasnetworks_route_mum 1" r2,
                		          "tejasnetworks_ptp_mum 1" p1,
            ...
            SELECT r1.snc_id,
                   ...
                   r1.tuple_a             aval,
                   r1.path_type
            FROM tejasnetworks_route_mum1 r1,
            tejasnetworks_route_mum1 r2,
            tejasnetworks_ptp_mum1 p1,
            tejasnetworks_ptp_mum1 p2
            WHERE r1.snc_id = r2.snc_id
              AND r1.tuple_a = '2'
              AND r2.tuple_a = '2'
     ...
     "tejasnetworks_topology_mum 1" t,
     "tejasnetworks_snc_mum 1" sn
